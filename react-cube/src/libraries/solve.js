(function () {
  ...
  Cube.prototype.solve = function (maxDepth = 22) {
    ...
    for(let step of solution)
    {
      ...
      else if(step == "R2") solve_step += "RR";
      else if(step == "F2") solve_step += "FF";
      else if(step == "B2") solve_step += "BB";

      else if(step == "U'") solve_step += "u";
      else if(step == "D'") solve_step += "d";
      else if(step == "L'") solve_step += "l";
      else if(step == "R'") solve_step += "r";
      else if(step == "F'") solve_step += "f";
      else if(step == "B'") solve_step += "b";

      else solve_step += step;
    }
